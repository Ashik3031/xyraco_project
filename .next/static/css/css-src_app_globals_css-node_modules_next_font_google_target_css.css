...
.border-\[\#f9faf8\]\/10 {
  border-color: rgb(249 250 248 / 0.1);
}
.border-accent\/10 {
  border-color: rgb(0 229 255 / 0.1);
}
.border-black\/10 {
...
.bg-accent\/5 {
  background-color: rgb(0 229 255 / 0.05);
}
.bg-background {
...
.shadow-\[0_40px_100px_-20px_rgba\(0\2c 0\2c 0\2c 0\.05\)\] {
  --tw-shadow: 0 40px 100px -20px rgba(0,0,0,0.05);
...
.placeholder\:text-black\/10::-moz-placeholder {
  color: rgb(0 0 0 / 0.1);
}
