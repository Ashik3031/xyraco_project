            ...
            <div className="sticky top-0 h-screen w-full flex items-center justify-center overflow-hidden">
                <div className="relative w-[85vw] h-[85vw] md:w-[75vh] md:h-[75vh] max-w-[600px] max-h-[600px] flex items-center justify-center">
                    ...
                    <motion.div
                        ...
                        className="relative z-10 text-center px-6 w-[160%] pointer-events-none translate-y-[-10%]"
                    >
                        <div className="overflow-visible mb-16">
                            <motion.h2
                                style={{ x: x1 }}
                                className="text-[12vw] md:text-[9vw] font-medium tracking-tighter text-white leading-none uppercase whitespace-nowrap mb-[-0.1em] relative z-20 drop-shadow-2xl"
                            >
                                <span>Let&apos;s BUILD</span>
                            </motion.h2>
                            <motion.h2
                                style={{ x: x2 }}
                                className="text-[12vw] md:text-[9vw] font-medium tracking-tighter stroke-text-white leading-[0.75] uppercase relative z-10"
                            >
                                <span>History.</span>
                            </motion.h2>
                        </div>
                        ...
                        <motion.div className="pointer-events-auto">
                            <motion.button
                                ...
                                whileTap={{ scale: 0.95 }}
                                className="group relative px-8 py-4 rounded-full bg-white text-black text-[10px] font-bold tracking-[0.3em] uppercase overflow-hidden transition-all duration-700"
                            >
                                <span className="relative z-10 flex items-center gap-3">
                                    Start Partnership
                                    <ArrowRight size={18} className="transition-transform group-hover:translate-x-2" />
                                </span>
                                <div className="absolute inset-0 bg-gray-100 translate-y-full group-hover:translate-y-0 transition-transform duration-700" />
                            </motion.button>
                        </motion.div>
                    </motion.div>
                </div>
